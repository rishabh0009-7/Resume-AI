...
export class AiService{
    ...
    async generateResumeContent(content:string , context :string = "resume " ){
        try {
    ...
    async enhanceResumeSection (sectionType:string , content :string , jobDescription :string){
        try {
    ...
    async generateSummary(experience: any[], skills: string[], jobDescription: string){
        try {
    ...
    async suggestSkills(jobDescription :string , currentSkills :string[] = []){
        try {
      ...
      throw new Error("Failed to optimize for ATS");
            ...
            async generateJobSpecificContent(content: string, jobDescription: string, sectionType: string) {
                try {
